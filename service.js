...
app.get("/products", (req, res) => {
  ...
  db.query(query, [...params, startIndex, limit], (err, results) => {
    if (err) {
    ...
    // Notice the alias "p" is added here to match the whereClause
    db.query(
